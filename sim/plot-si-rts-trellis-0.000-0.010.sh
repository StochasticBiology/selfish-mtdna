...
set origin 0,0
lambda1 = 0.1
set label 1 at graph 0.05, graph 0.9 "λ₁ = 0.1, D = 0.01" front
set xrange [-lambda1-offset:0.9-lambda1-offset]
splot "mtdna-mito-0.000-0.010-overall-0.100.txt" u ($1-lambda1):2:(2*($3-0.5))

set origin 0.33,0
lambda1 = 0.2
set label 1 at graph 0.05, graph 0.9 "λ₁ = 0.2, D = 0.01" front
set xrange [-lambda1-offset:0.9-lambda1-offset]
splot "mtdna-mito-0.000-0.010-overall-0.200.txt" u ($1-lambda1):2:(2*($3-0.5))

set origin 0.66,0
lambda1 = 0.3
#set label 2 at graph 0.92,graph 0.85 "*, D = 0.01" front
set label 1 at graph 0.05, graph 0.9 "λ₁ = 0.3, D = 0.01" front
set xrange [-lambda1-offset:0.9-lambda1-offset]
