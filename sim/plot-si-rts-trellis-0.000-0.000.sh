...
splot "mtdna-mito-0.000-0.000-overall-0.100.txt" u ($1-lambda1):2:(2*($3-0.5))

set origin 0.33,0
lambda1 = 0.2
set label 1 at graph 0.05, graph 0.9 "λ₁ = 0.2" front
set xrange [-lambda1-offset:0.9-lambda1-offset]
splot "mtdna-mito-0.000-0.000-overall-0.200.txt" u ($1-lambda1):2:(2*($3-0.5))
...
set xrange [-lambda1-offset:0.9-lambda1-offset]
splot "mtdna-mito-0.000-0.000-overall-0.300.txt" u ($1-lambda1):2:(2*($3-0.5))
...
set xrange [-lambda1-offset:0.9-lambda1-offset]
splot "mtdna-mito-0.000-0.000-overall-0.400.txt" u ($1-lambda1):2:(2*($3-0.5))

set origin 0.33,0.33
lambda1 = 0.5
set label 1 at graph 0.05, graph 0.9 "λ₁ = 0.5" front
set xrange [-lambda1-offset:0.9-lambda1-offset]
splot "mtdna-mito-0.000-0.000-overall-0.500.txt" u ($1-lambda1):2:(2*($3-0.5))

set origin 0.66,0.33
lambda1 = 0.6
set label 1 at graph 0.05, graph 0.9 "λ₁ = 0.6" front
set xrange [-lambda1-offset:0.9-lambda1-offset]
splot "mtdna-mito-0.000-0.000-overall-0.600.txt" u ($1-lambda1):2:(2*($3-0.5))
...
set xrange [-lambda1-offset:0.9-lambda1-offset]
splot "mtdna-mito-0.000-0.000-overall-0.700.txt" u ($1-lambda1):2:(2*($3-0.5))

set origin 0.33,0.66
lambda1 = 0.8
set label 1 at graph 0.05, graph 0.9 "λ₁ = 0.8" front
set xrange [-lambda1-offset:0.9-lambda1-offset]
splot "mtdna-mito-0.000-0.000-overall-0.800.txt" u ($1-lambda1):2:(2*($3-0.5))

set origin 0.66,0.66
lambda1 = 0.9
set label 1 at graph 0.05, graph 0.9 "λ₁ = 0.9" front
set xrange [-lambda1-offset:0.9-lambda1-offset]
splot "mtdna-mito-0.000-0.000-overall-0.900.txt" u ($1-lambda1):2:(2*($3-0.5))
